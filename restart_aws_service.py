...
#       `aws ecs update-service --force-new-deployment` doesn't work so I kill the task and the service restarts it.
#       See my comments in this post answer: https://stackoverflow.com/a/58204611/1121497

task_definition = "HintsApp-TaskDefinition"
service = "HintsAppService"
